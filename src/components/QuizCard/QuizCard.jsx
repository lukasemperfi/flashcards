		...
		<div className={classes.card}>
			<div className={classes.cardHeader}>
				<div className={classes.cardBtns}>
					<Space size='middle'>
						<Button name='notCorrect' type="ghost" icon={<CloseOutlined className={classes.noBtnIcon} />} className={classes.noBtn} onClick={onBtnclick}>Не знаю</Button>
						<Button name='correct' type="primary" icon={<CheckOutlined className={classes.yesBtnIcon} />} className={classes.yesBtn} onClick={onBtnclick}>Знаю</Button>
					</Space>
				</div>
